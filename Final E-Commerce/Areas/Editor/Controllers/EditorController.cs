...
namespace Final_E_Commerce.Areas.Editor.Controllers
{
    ...
    public class EditorController:Controller
    {
        ...
        public async Task<IActionResult> NewBlog(WriteBlogVM blog)
        {
            ...
            NewBlog.Date = DateTime.Now.AddHours(12);
            ...
            {
                token = $"{NewBlog.Content.Substring(0,50)}... <a style='color: red' href='http://rammkhalid-001-site1.itempurl.com/blog/detail/{NewBlog.Id}'>read more</a> ";
        ...
        public async Task<IActionResult> Update(int? id, BlogEditVM editVM)
        {
            ...
            blog.LastUpdated = DateTime.Now.AddHours(12);
